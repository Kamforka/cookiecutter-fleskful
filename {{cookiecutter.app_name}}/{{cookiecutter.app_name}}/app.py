...
from {{cookiecutter.app_name}}.auth import jwt
from {{cookiecutter.app_name}}.extensions import api, bcrypt, cache, cors, db, migrate
from {{cookiecutter.app_name}}.resources import users
